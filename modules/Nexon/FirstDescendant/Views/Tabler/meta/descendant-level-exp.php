<section id="view-nexon-first-descendant-meta-descendant-level-exp">
    <?php
    ...
    <div class="card mb-3">
        <div class="list-group list-group-flush list-group-hoverable">
            ...
            <div class="list-group-item">
                ...
                <div class="d-block text-secondary text-truncate mt-n1">Lv. <?php echo $row['descendant_level']; ?></div>
            </div>
                <?php
            }
            ?>
